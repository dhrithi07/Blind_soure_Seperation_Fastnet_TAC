...
def apply_aggressive_masking(mix_file, est_files, alpha=3.0):
    ...
    # Named to match your evaluation_soft.py requirements
...
if __name__ == "__main__":
    ...
    if os.path.exists(mix) and os.path.exists(estimates[0]):
        # Higher Alpha = Higher SIR (Separation)
        apply_aggressive_masking(mix, estimates, alpha=3.0)
    else:
        print("Error: Input files (mix or fasnet_output) not found.")